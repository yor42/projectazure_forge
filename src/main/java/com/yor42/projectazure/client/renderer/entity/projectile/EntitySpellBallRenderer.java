...
public class EntitySpellBallRenderer extends EntityRenderer<EntitySpellBall> {
    ...
    public EntitySpellBallRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager);
    }
    ...
    private static void vertex(VertexConsumer builder, Matrix4f p_229045_1_, Matrix3f p_229045_2_, int p_229045_3_, float p_229045_4_, int p_229045_5_, int p_229045_6_, int p_229045_7_) {
    ...
    @Override
    public ResourceLocation getTextureLocation(EntitySpellBall entity) {
        return TEXTURE;
    }
}
