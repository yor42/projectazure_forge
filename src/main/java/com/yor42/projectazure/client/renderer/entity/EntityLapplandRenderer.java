...
public class EntityLapplandRenderer extends GeoCompanionRenderer<EntityLappland> {
    ...
    @Override
    public void renderEarly(EntityLappland animatable, MatrixStack stackIn, float ticks, @Nullable MultiBufferSource renderTypeBuffer, @Nullable VertexConsumer  vertexBuilder, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float partialTicks) {
    ...
    @Override
    public void render(@Nonnull EntityLappland entity, float entityYaw, float partialTicks, MatrixStack stack, MultiBufferSource bufferIn, int packedLightIn) {
        stack.pushPose();
