...
public class entityJavelinRenderer extends GeoCompanionRenderer<EntityJavelin> {
    ...
    @Override
    public void renderEarly(EntityJavelin animatable, PoseStack stackIn, float ticks, @Nullable MultiBufferSource renderTypeBuffer, @Nullable VertexConsumer  vertexBuilder, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float partialTicks) {
    ...
    @Override
    public void render(EntityJavelin entity, float entityYaw, float partialTicks, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn) {
        stack.pushPose();
    ...
    @Override
    public RenderType getRenderType(EntityJavelin animatable, float partialTicks, PoseStack stack, @Nullable MultiBufferSource renderTypeBuffer, @Nullable VertexConsumer  vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
