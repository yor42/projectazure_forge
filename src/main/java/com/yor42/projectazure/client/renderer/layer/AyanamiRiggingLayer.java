...
public class AyanamiRiggingLayer extends GeoLayerRenderer<EntityAyanami> {
    ...
    @Override
    public void render(MatrixStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, EntityAyanami entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
