...
public class EnterpriseRiggingLayer extends GeoLayerRenderer<EntityEnterprise> {
    ...
    @Override
    public void render(MatrixStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, EntityEnterprise entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
