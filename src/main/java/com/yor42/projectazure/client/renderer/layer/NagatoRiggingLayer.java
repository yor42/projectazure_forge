...
public class NagatoRiggingLayer extends GeoLayerRenderer<EntityNagato> {
    ...
    @Override
    public void render(MatrixStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, EntityNagato entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
