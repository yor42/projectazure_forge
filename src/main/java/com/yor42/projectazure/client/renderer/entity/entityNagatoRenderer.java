...
public class entityNagatoRenderer extends GeoCompanionRenderer<EntityNagato> {
    ...
    @Override
    public void renderEarly(EntityNagato animatable, MatrixStack stackIn, float ticks, @Nullable MultiBufferSource renderTypeBuffer, @Nullable VertexConsumer  vertexBuilder, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float partialTicks) {
    ...
    @Override
    public void render(EntityNagato entity, float entityYaw, float partialTicks, MatrixStack stack, MultiBufferSource bufferIn, int packedLightIn) {
    ...
    @Override
    public RenderType getRenderType(EntityNagato animatable, float partialTicks, MatrixStack stack, @Nullable MultiBufferSource renderTypeBuffer, @Nullable VertexConsumer  vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
