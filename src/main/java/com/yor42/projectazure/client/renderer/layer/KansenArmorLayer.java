...
public class KansenArmorLayer extends LayerRenderer<EntityKansenBase, EntityModel<EntityKansenBase>> {
    ...
    @Override
    public void render(MatrixStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, EntityKansenBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
