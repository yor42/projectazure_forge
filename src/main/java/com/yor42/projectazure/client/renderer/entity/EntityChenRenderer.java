...
public class EntityChenRenderer extends GeoCompanionRenderer<EntityChen> {
    ...
    @Override
    public void renderEarly(EntityChen animatable, MatrixStack stackIn, float ticks, MultiBufferSource renderTypeBuffer, VertexConsumer  vertexBuilder, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float partialTicks) {
    ...
    @Override
    public void render(@Nonnull EntityChen entity, float entityYaw, float partialTicks, MatrixStack stack, @Nonnull MultiBufferSource bufferIn, int packedLightIn) {
        stack.pushPose();
    ...
    @Override
    public RenderType getRenderType(EntityChen animatable, float partialTicks, MatrixStack stack, @Nullable MultiBufferSource renderTypeBuffer, @Nullable VertexConsumer  vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
