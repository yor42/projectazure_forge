...
public class EntityBlackHoleRenderer extends EntityRenderer<EntityCausalBlackhole> {
    ...
    public EntityBlackHoleRenderer(EntityRendererProvider.Context p_i46179_1_) {
        super(p_i46179_1_);
    }

    @Override
    public void render(EntityCausalBlackhole p_225623_1_, float p_225623_2_, float p_225623_3_, PoseStack p_225623_4_, MultiBufferSource p_225623_5_, int packedLightIn) {
    ...
    private static void vertex(VertexConsumer builder, Matrix4f matrix, Matrix3f p_229045_2_, int p_229045_3_, float p_229045_4_, int p_229045_5_, int p_229045_6_, int p_229045_7_) {
