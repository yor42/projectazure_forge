...
public class ModelSaori extends GeoCompanionModel<EntitySaori> {
    @Override
    public ResourceLocation getModelLocation(EntitySaori object) {
        return GeoModelEntityLocation("modelsaori");
    }

    @Override
    public ResourceLocation getTextureLocation(EntitySaori object) {
        return TextureEntityLocation("Pat");
    }

    @Override
    public ResourceLocation getAnimationFileLocation(EntitySaori animatable) {
        return AnimationLocation("entity/gunuser/saori");
    }

    @Override
    public void setCustomAnimations(EntitySaori entity, int uniqueID, @Nullable AnimationEvent customPredicate) {
