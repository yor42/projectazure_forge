...
public class LapplandModel extends GeoCompanionModel<EntityLappland> {
    ...
    @Override
    public void setCustomAnimations(EntityLappland entity, int uniqueID, @Nullable AnimationEvent customPredicate) {
