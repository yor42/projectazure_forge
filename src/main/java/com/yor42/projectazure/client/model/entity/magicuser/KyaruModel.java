...
public class KyaruModel extends GeoCompanionModel<EntityKyaru> {

    @Override
    public ResourceLocation getModelLocation(EntityKyaru object) {
        return GeoModelEntityLocation("modelkyaru");
    }

    @Override
    public ResourceLocation getTextureLocation(EntityKyaru object) {
        return TextureEntityLocation("modelkyaru");
    }

    @Override
    public ResourceLocation getAnimationFileLocation(EntityKyaru animatable) {
        return new ResourceLocation(Constants.MODID,"animations/entity/spelluser/kyaru.animation.json");
    }

    @Override
    public void setLivingAnimations(EntityKyaru entity, Integer uniqueID, @Nullable AnimationEvent customPredicate) {
