...
public class enterpriseModel extends GeoCompanionModel<EntityEnterprise> {
    ...
    @Override
    public void setCustomAnimations(EntityEnterprise entity, int uniqueID, @Nullable AnimationEvent customPredicate) {
