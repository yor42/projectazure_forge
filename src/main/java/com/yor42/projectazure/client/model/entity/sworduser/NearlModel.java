...
public class NearlModel extends GeoCompanionModel<EntityNearl> {

    @Override
    public ResourceLocation getModelLocation(EntityNearl object) {
        return GeoModelEntityLocation("modelnearl");
    }

    @Override
    public ResourceLocation getTextureLocation(EntityNearl object) {
        return TextureEntityLocation("modelnearl");
    }

    @Override
    public ResourceLocation getAnimationFileLocation(EntityNearl animatable) {
        return new ResourceLocation(Constants.MODID,"animations/entity/sworduser/nearl.animation.json");
    }

    @Override
    public void setLivingAnimations(EntityNearl entity, Integer uniqueID, @Nullable AnimationEvent customPredicate) {
