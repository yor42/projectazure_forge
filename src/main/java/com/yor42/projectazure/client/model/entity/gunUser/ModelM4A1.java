...
public class ModelM4A1 extends GeoCompanionModel<EntityM4A1> {
    ...
    @Override
    public void setCustomAnimations(EntityM4A1 entity, int uniqueID, @Nullable AnimationEvent customPredicate) {
