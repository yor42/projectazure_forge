...
public class ModelExcela extends GeoCompanionModel<EntityExcela> {

    @Override
    public ResourceLocation getModelLocation(EntityExcela object) {
        return GeoModelEntityLocation("modelexcela");
    }

    @Override
    public ResourceLocation getTextureLocation(EntityExcela object) {
        return TextureEntityLocation("modelexcella");
    }

    @Override
    public ResourceLocation getAnimationFileLocation(EntityExcela animatable) {
        return new ResourceLocation(Constants.MODID,"animations/entity/bonus/excella.animation.json");
    }
