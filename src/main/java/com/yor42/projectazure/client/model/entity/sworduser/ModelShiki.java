...
public class ModelShiki extends GeoCompanionModel<EntityShiki> {
    ...
    public ResourceLocation getModelLocation(EntityShiki object) {
        return GeoModelEntityLocation("modelshiki");
    }

    @Override
    public ResourceLocation getTextureLocation(EntityShiki object) {
        return TextureEntityLocation("modelshiki");
    }

    @Override
    public ResourceLocation getAnimationFileLocation(EntityShiki animatable) {
        return new ResourceLocation(Constants.MODID,"animations/entity/sworduser/shiki.animation.json");
    }
