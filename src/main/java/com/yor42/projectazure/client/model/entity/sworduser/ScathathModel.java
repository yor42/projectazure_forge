...
public class ScathathModel extends GeoCompanionModel<EntityScathath> {
    ...
    public ResourceLocation getModelLocation(EntityScathath object) {
        return GeoModelEntityLocation("modelscathath");
    }

    @Override
    public ResourceLocation getTextureLocation(EntityScathath object) {
        return TextureEntityLocation("modelscathath");
    }

    @Override
    public ResourceLocation getAnimationFileLocation(EntityScathath animatable) {
        return new ResourceLocation(Constants.MODID,"animations/entity/sworduser/scathath.animation.json");
    }

    @Override
    public void setCustomAnimations(EntityScathath entity, int uniqueID, @Nullable AnimationEvent customPredicate) {
