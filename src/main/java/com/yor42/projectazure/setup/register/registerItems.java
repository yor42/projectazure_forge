...
public class registerItems {
    ...
    public static final RegistryObject<Item> GLITCHED_PHONE = registerManager.ITEMS.register("glitched_phone", () -> new ItemGlitchedPhone(new Item.Properties().stacksTo(1).tab(PA_GROUP)));
    ...
    public static final RegistryObject<Item> TACTICAL_KNIFE = registerManager.ITEMS.register("tactical_knife", () -> new ItemThrowableKnife(ModMaterials.KNIFE, 3, -0.2F, new Item.Properties().tab(PA_WEAPONS)));
