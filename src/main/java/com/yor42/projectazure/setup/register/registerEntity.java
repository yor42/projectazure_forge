...
public class registerEntity {
    ...
    public static final RegistryObject<EntityType<EntityFallingSword>> PROJECTILE_FALLINGSWORD = ENTITIES.register("entityfaillingsword", () -> EntityType.Builder.<EntityFallingSword>of(EntityFallingSword::new, EntityClassification.MISC).sized(1F, 1F).build(ModResourceLocation("projectilefallingsword").toString()));
