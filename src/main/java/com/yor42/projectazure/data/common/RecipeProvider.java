...
public class RecipeProvider extends net.minecraft.data.RecipeProvider {
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        BuildMetalRecipe(consumer, 0.5F, new Metals("brass", registerItems.INGOT_BRASS.get(), ModTags.Items.INGOT_BRASS).dust(registerItems.DUST_BRASS.get(), ModTags.Items.DUST_BRASS).plates(registerItems.PLATE_BRASS.get(), ModTags.Items.PLATE_BRASS));
