...
/**
 * This code is from smartbrainlib by Tslat, Under Mozilla Public License 2.0 license.
 * you may obtain copy of license file on https://github.com/Tslat/SmartBrainLib/blob/1.19.4/LICENSE.
 */
...
public abstract class BreakBlockSwitchingItem <E extends LivingEntity> extends ExtendedItemSwitchingTasks<E> {
     ...
     * @return this
     */
    public BreakBlockSwitchingItem<E> stopBreakingIf(TriPredicate<E, BlockPos, BlockState> predicate) {
     ...
     * @return this
     */
    public BreakBlockSwitchingItem<E> forBlocks(TriPredicate<E, BlockPos, BlockState> predicate) {
     ...
     * @return this
     */
    public BreakBlockSwitchingItem<E> timeToBreak(TriFunction<E, BlockPos, BlockState, Integer> function) {
