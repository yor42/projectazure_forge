...
import com.yor42.projectazure.gameobject.entity.ai.tasks.CompanionSitTask;
import com.yor42.projectazure.gameobject.entity.ai.tasks.CompanionStayNearPointTask;
import com.yor42.projectazure.gameobject.entity.ai.tasks.FollowOwnerTask;
...
import static com.yor42.projectazure.setup.register.registerManager.FOLLOWING_OWNER;
import static com.yor42.projectazure.setup.register.registerManager.SITTING;
...
public class CompanionTasks {
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super AbstractEntityCompanion>>> getCorePackage(float p_220638_1_) {
        return ImmutableList.of(Pair.of(0, new SwimTask(0.8F)), Pair.of(0, new InteractWithDoorTask()), Pair.of(0, new LookTask(45, 90)), Pair.of(0, new WakeUpTask()), Pair.of(5, new PickupWantedItemTask(p_220638_1_, false, 4)), Pair.of(1, new WalkToTargetTask()), Pair.of(10, new GatherPOITask(PointOfInterestType.HOME, MemoryModuleType.HOME, false, Optional.of((byte)14))));
    }

    public static ImmutableList<Pair<Integer, ? extends Task<? super AbstractEntityCompanion>>> getFollowOwnerPackage() {
        return ImmutableList.of(Pair.of(0, new FollowOwnerTask()), Pair.of(3, new FindInteractionAndLookTargetTask(EntityType.PLAYER, 4)));
    }
