...
public class CompanionMovetoTargetTask extends Task<AbstractEntityCompanion> {
    ...
    public CompanionMovetoTargetTask() {
        this(150, 250);
    }

    public CompanionMovetoTargetTask(int p_i241908_1_, int p_i241908_2_) {
    ...
    private boolean reachedTarget(AbstractEntityCompanion p_220486_1_, WalkTarget p_220486_2_) {
