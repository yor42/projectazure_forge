...
public class CompanionPickupItemGoal extends Goal {
    ...
    private List<ExperienceOrb> Explist;
    ...
    public boolean canUse() {
        ...
        this.Explist = this.host.getCommandSenderWorld().getEntitiesOfClass(ExperienceOrb.class, this.host.getBoundingBox().inflate(this.range));
    ...
    public void tick() {
        ...
        if(!this.Lootlist.isEmpty()) {
            ...
            for (ExperienceOrb orbEntity : this.Explist) {
